...
import com.empowerbits.dronifyit.Activities.AddProject.ProjectInfoActivity;
import com.empowerbits.dronifyit.Activities.MediaManagerActivity;
import com.empowerbits.dronifyit.Activities.WaypointActivity;
import com.empowerbits.dronifyit.Adapters.OnProjectClickListener;
import com.empowerbits.dronifyit.Adapters.OnProjectEditClickListener;
import com.empowerbits.dronifyit.Adapters.ProjectAdapter;
    ...
    private void openMediaManagerWithProject(Project project, int flightIndex) {
        try {
            ...
            if(flightLog.getEnded_at() == null || flightLog.getEnded_at().equals("")){
                ...
                Gson gson = new Gson();
                com.empowerbits.dronifyit.models.Log log = gson.fromJson(json, com.empowerbits.dronifyit.models.Log.class);
