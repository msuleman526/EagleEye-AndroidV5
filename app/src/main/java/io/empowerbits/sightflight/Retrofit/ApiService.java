package io.empowerbits.sightflight.Retrofit;
...
public interface ApiService {
    ...
    @FormUrlEncoded
    @POST("projects")
    Call<AddProjectResponse> createProjectInfo(@Header("Authorization") String token, @Field("address") String address, @Field("latitude") String latitude, @Field("longitude") String longitude, @Field("assign_to") int assign_to, @Field("name") String name, @Field("flight_setting") String flightSettings, @Field("flight_path") String flightPath);

    @FormUrlEncoded
    @PUT("projects/update/{projectId}")
    Call<AddProjectResponse> updateProjectInfo(@Header("Authorization") String token, @Path("projectId") String projectId, @Field("address") String address, @Field("latitude") String latitude, @Field("longitude") String longitude, @Field("name") String name, @Field("flight_setting") String flightSettings, @Field("flight_path") String flightPath);
